...
public class Day21IndependentAndDependent {
	public static void main(String[] args) throws InterruptedException {
		...
		// shortcut way indepedent and dependent
		WebElement web1 = driver.findElement(By.xpath("(//a[text()='3rd Album'])[1]/../../div[3]/div[1]/span"));
		System.out.println(web1.getText());
		Thread.sleep(1000);
		WebElement web2 = driver.findElement(By.xpath("(//a[text()='Music 2'])[1]/../../div[3]/div[1]/span"));
		System.out.println(web2.getText());
		Thread.sleep(1000);
		WebElement web3 = driver.findElement(By.xpath("(//a[text()='Music 2'])[2]/../../div[3]/div[1]/span"));
