...
public class TestisDisplayedusingWebelements {
		...
		{Thread.sleep(2000);
			...
			if(Digital_downloads.isDisplayed())
			{
				...
				if(shopping_Cart.isDisplayed())
				{
					...
					List<WebElement> shopping_Cart1 = driver.findElements(By.cssSelector("input[name='removefromcart']"));
					for (WebElement web : shopping_Cart1)
					{
						web.click();
						Thread.sleep(1000);	
					} 
